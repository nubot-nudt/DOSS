...
class cylinder_asym(nn.Module):
    ...
    def forward_ow_complete(self, train_pt_fea_ten, train_vox_ten, batch_size):
        coords, features_3d = self.cylinder_3d_generator(train_pt_fea_ten, train_vox_ten)

        spatial_features = self.cylinder_3d_spconv_seg.forward_ow(features_3d, coords, batch_size)
